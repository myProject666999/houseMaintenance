...
import { Card, Table, Tag, Button, message, Spin, Modal, Descriptions, Rate } from 'antd';
...
const Evaluations = () => {
  ...
  const fetchEvaluations = async () => {
    setLoading(true);
    try {
      const res = await repairerAPI.getMyEvaluations();
        ...
        {currentEvaluation && (
          <Descriptions column={1} bordered>
            ...
            <Descriptions.Item label="业主">
              {currentEvaluation.owner?.real_name || currentEvaluation.owner?.username || '-'}
            </Descriptions.Item>
